...
import ir.maktab.bours.scholarshipexploringfeature.usecase.FindScholarshipByUniversityUseCase;
        ...
        if (loginUser != null) {
            if (loginUser.getRole().equals("Superviser")) {
                ...
                try {
                    ...
                    // query
                    String sql = "select * from scholarship where status = 'AcceptByManager' ";
                    // result
